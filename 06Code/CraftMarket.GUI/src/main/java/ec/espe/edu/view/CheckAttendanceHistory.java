 ...
 * @author ESPE
 */
public class CheckAttendanceHistory extends javax.swing.JFrame {

    /**
     * Creates new form CheckAttendanceHistory
     */
    public CheckAttendanceHistory() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CheckAttendanceHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CheckAttendanceHistory().setVisible(true);
            }
        });
    }
