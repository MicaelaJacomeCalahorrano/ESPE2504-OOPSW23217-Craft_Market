...
import ec.espe.edu.controller.SaleCalculator;
import ec.espe.edu.controller.StockManager;
 ...
 private void loadProductsToTable() {
    ...
    for (Product product : products) {
        Object[] row = {
            product.getId(),
            product.getName(),
            product.getUnitPrice(), // Pasa como Double o Float, no String
            product.getStock(),
            product.getOwner()
        };
        model.addRow(row);
    ...
    private void btnSaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaleActionPerformed
        ...
        if (productIdText.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Por favor ingrese el ID del producto.", "Advertencia", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        if (quantity > product.getStock()) {
            JOptionPane.showMessageDialog(this, "Stock insuficiente. Solo hay " + product.getStock() + " unidades disponibles.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
